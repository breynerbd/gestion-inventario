...
import com.gestioninventario.backend.application.dto.rol.RolEstadoDTO;
...
import com.gestioninventario.backend.application.service.RolService;
...
public class RolController {
    ...
    @PatchMapping("/{id_rol}/estado")
    public ResponseEntity<RolResponseDTO> cambiarEstado(@PathVariable("id_rol") Long id_rol, @Valid @RequestBody RolEstadoDTO estadoDto) {
        return ResponseEntity.ok(service.cambiarEstado(id_rol,estadoDto.getEstado()));
    }
}